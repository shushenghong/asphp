...
class Base2n {
     ...
     */
    public function __construct($bitsPerCharacter, $chars = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_', $caseSensitive = TRUE, $rightPadFinalBits = FALSE, $padFinalGroup = FALSE, $padCharacter = '=') {
        ...
        elseif( $charLength < 1 << $bitsPerCharacter ) {
            ...
            throw new InvalidArgumentException( 
                    '$bitsPerCharacter can not be more than ' . $bitsPerCharacter . ' given $chars length of ' . $charLength . ' (max radix ' . $radix .
                             ')' );
        }
